...
func init() {
	collections := map[string]string{
		...
		"loadbalanceraddress":    "loadbalanceraddresses",
	...
	resources := map[string]func() core.Resource{
		"actionplan":             func() core.Resource { return new(ActionPlan) },
		...
		"harddisk":               func() core.Resource { return new(HardDisk) },
		...
		"loadbalanceraddress":    func() core.Resource { return new(LoadBalancerAddress) },
		...
		"task":                   func() core.Resource { return new(Task) },
