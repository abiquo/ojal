...
type CostCode struct {
	CurrencyPrices []ResourcePrice `json:"currencyPrices"`
...
type AbstractDCPrice struct {
	DatastoreTiers []ResourcePrice `json:"pricingDatastoreTiers,omitempty"`
	HPAbstractDC   []ResourcePrice `json:"pricingHardwareProfilesAbsDc,omitempty"`
	Tiers          []ResourcePrice `json:"pricingTiers,omitempty"`
...
type PricingTemplate struct {
	...
	CostCodes            []ResourcePrice   `json:"pricingCostCodes,omitempty"`
